...
has a maximum capacity. When new key values are added to a map at full capacity
a least frequently used key by the find method is evicted and the new key mapping
is then added.
